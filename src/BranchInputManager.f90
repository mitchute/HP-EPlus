MODULE BranchInputManager
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, OutputFileBNDetails, DisplayExtraWarnings !, ShowFatalError, ShowWarningError, &
  !ShowSevereError, ShowMessage, ShowContinueError
  !USE DataInterfaces, ONLY: ShowSevereMessage
  USE DataLoopNode
