MODULE CurveManager
  ...
  USE DataGlobals_HPSimIntegrated,    ONLY: MaxNameLength, AnyEnergyManagementSystemInModel !, ShowSevereError, ShowWarningError, ShowFatalError, ShowContinueError
  ...
  USE DataInterfaces, ONLY:  SetupEMSActuator, ShowRecurringWarningErrorAtEnd
...
CONTAINS
  ...
  REAL(r64) FUNCTION CurveValue(CurveIndex,Var1,Var2,Var3, Var4, Var5)
    ...
    ! USE STATEMENTS:
    USE DataGlobals_HPSimIntegrated,    ONLY: BeginEnvrnFlag !, ShowFatalError
  ...
  SUBROUTINE GetCurveInput
    ...
    !  USE DataGlobals_HPSimIntegrated, ONLY: DisplayExtraWarnings, OutputFileInits
...
SUBROUTINE ReadTableData(CurveNum, CurrentModuleObject, ReadFromFile, FileName, Alphas, Numbers, NumNumbers, ErrorsFound)
  ...
  USE General,             ONLY: RoundSigDigits
  USE DataGlobals_HPSimIntegrated,         ONLY: DisplayAdvancedReportVariables, OutputFileInits
...
SUBROUTINE SolveRegression(CurveNum, TableType, CurveName, RawDataX, RawDataY, RawDataX2)
  ...
  USE DataGlobals_HPSimIntegrated,    ONLY: DisplayAdvancedReportVariables, OutputFileInits !, ShowContinueError, ShowSevereError
