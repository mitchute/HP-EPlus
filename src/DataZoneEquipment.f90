MODULE DataZoneEquipment      ! EnergyPlus Data-Only Module
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, NumOfZones
...
CONTAINS
  ...
  SUBROUTINE GetZoneEquipmentData1
    ...
    USE DataGlobals_HPSimIntegrated, ONLY: NumOfZones !, ShowSevereError, ShowContinueError, ShowFatalError, ShowWarningError
