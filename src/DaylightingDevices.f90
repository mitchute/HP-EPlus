...
USE DataGlobals_HPSimIntegrated,     ONLY: NumOfZones, MaxNameLength, DegToRadians, Pi, PiOvr2, OutputFileInits !, &
...
REAL(r64) FUNCTION CalcTDDTransSolAniso(PipeNum, COSI)
          ...
          ! USE STATEMENTS: na
  USE DataGlobals_HPSimIntegrated, ONLY: HourOfDay, TimeStep
