...
USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, NumOfTimeStepInHour, SecInHour
...
SUBROUTINE ManageDemand
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: WarmupFlag, DoingSizing !, ShowFatalError
...
SUBROUTINE SimulateDemandManagerList(ListNum, ResimExt, ResimHB, ResimHVAC)
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: TimeStepZone, SecInHour
...
SUBROUTINE GetDemandManagerListInput
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, MinutesPerTimeStep !, ShowSevereError, &
...
SUBROUTINE GetDemandManagerInput
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, MinutesPerTimeStep !, ShowSevereError, ShowWarningError, &
...
SUBROUTINE UpdateDemandManagers
  ...
  ! It updates availability flags, expires managers that ended in the last timestep, etc.
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: MinutesPerTimeStep
