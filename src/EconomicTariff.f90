MODULE EconomicTariff
  ...
  USE InputProcessor
  USE DataGlobals_HPSimIntegrated ,   ONLY : MaxNameLength !, ShowSevereError, ShowWarningError, ShowContinueError
...
CONTAINS
  ...
  SUBROUTINE UpdateUtilityBills
    ...
    USE DataGlobals_HPSimIntegrated, ONLY: DoOutputReporting, KindOfSim, ksRunPeriodWeather !, ShowFatalError
  ...
  SUBROUTINE GetInputEconomicsTariff
    ...
    USE DataGlobals_HPSimIntegrated, ONLY: NumOfTimeStepInHour
    USE OutputReportTabular, ONLY: AddTOCEntry
...
SUBROUTINE GetInputEconomicsCurrencyType
  ...
  ! USE STATEMENTS:
  !USE DataGlobals_HPSimIntegrated, ONLY :  ShowWarningError
...
SUBROUTINE GatherForEconomics
  ...
  USE DataGlobals_HPSimIntegrated,     ONLY: HourOfDay,TimeStep,SecInHour,TimeStepZone
