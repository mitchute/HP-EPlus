...
USE DataGenerators
USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, OutputFileInits, HoursInDay !, ShowWarningError, &
...
MODULE GeneratorDynamicsManager
          ...
          ! USE STATEMENTS:
USE DataGenerators
USE DataGlobals_HPSimIntegrated,    ONLY: CurrentTime, DayOfSim, HoursInDay, SecInHour !, ShowFatalError, ShowContinueError
          ! <use statements for access to subroutines in other modules>
...
USE DataGenerators
USE DataLoopNode
USE DataGlobals_HPSimIntegrated ,   ONLY : MaxNameLength, NumOfTimeStepInHour, NumOfZones, KelvinConv, HoursInDay
USE DataInterfaces
...
SUBROUTINE InitMicroCHPNoNormalizeGenerators(GeneratorNum, FirstHVACIteration)
          ...
          ! USE STATEMENTS:
  Use DataHVACGlobals, ONLY: SysTimeElapsed, TimeStepSys
  USE DataGlobals_HPSimIntegrated    , ONLY: TimeStep, TimeStepZone, SecInHour, BeginEnvrnFlag, HourOfDay, &
...
SUBROUTINE CalcMicroCHPNoNormalizeGeneratorModel(GeneratorNum,RunFlagElectCenter,  &
  ...
  Use DataHVACGlobals, ONLY: SysTimeElapsed, TimeStepSys
  USE DataGlobals_HPSimIntegrated    , ONLY: TimeStep, TimeStepZone, SecInHour, HoursInDay
  USE CurveManager,    ONLY: CurveValue
  USE DataGlobalConstants
...
USE DataGenerators
USE DataLoopNode
USE DataGlobals_HPSimIntegrated ,   ONLY : MaxNameLength, NumOfTimeStepInHour, NumOfZones, CurrentTime, DayOfSim, SecInHour,   &
...
SUBROUTINE GetFuelCellGeneratorInput
  ...
  USE ScheduleManager, ONLY: GetScheduleIndex
  USE General, ONLY: RoundSigDigits
  USE DataGlobals_HPSimIntegrated, ONLY: DisplayAdvancedReportVariables
...
MODULE ICEngineElectricGenerator
          ...
          ! USE STATEMENTS:
USE DataLoopNode
USE DataGlobals_HPSimIntegrated ,   ONLY : MaxNameLength, NumOfTimeStepInHour, SecInHour, BeginEnvrnFlag, InitConvTemp !, &
