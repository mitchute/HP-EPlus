MODULE ManageElectricPower
  ...
  USE DataLoopNode
  USE DataGlobals_HPSimIntegrated,         ONLY : MaxNameLength, NumOfTimeStepInHour, TimeStepZone, SecInHour !, &
...
CONTAINS
  ...
  SUBROUTINE ManageElectricLoadCenters(FirstHVACIteration,SimElecCircuits, UpdateMetersOnly)
    ...
    USE DataGlobals_HPSimIntegrated,     ONLY: dooutputreporting, MetersHaveBeenInitialized, warmupflag, &
...
SUBROUTINE ManageElectCenterStorageInteractions(LoadCenterNum,StorageDrawnPower,StorageStoredPower)
  ...
  USE ScheduleManager, ONLY: GetCurrentScheduleValue
  USE DataGlobals_HPSimIntegrated    , ONLY: TimeStep, TimeStepZone, SecInHour, BeginEnvrnFlag, WarmupFlag, HourOfDay
...
SUBROUTINE ManageTransformers()
  ...
  ! USE STATEMENTS:
  USE DataHVACGlobals, ONLY: TimeStepSys
  USE DataGlobals_HPSimIntegrated    , ONLY: TimeStepZone, SecInHour, MetersHaveBeenInitialized
  USE ScheduleManager, ONLY: GetCurrentScheduleValue
