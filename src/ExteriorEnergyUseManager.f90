MODULE ExteriorEnergyUse
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, TimeStepZone !, ShowWarningError, ShowSevereError, ShowFatalError, ShowContinueError
...
CONTAINS
  ...
  SUBROUTINE ReportExteriorEnergyUse
    ...
    ! USE STATEMENTS:
    USE DataGlobals_HPSimIntegrated, ONLY: SecInHour,WarmUpFlag, DoOutputReporting, KindOfSim, ksRunPeriodWeather
