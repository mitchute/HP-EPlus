MODULE FanCoilUnits
  ...
  USE DataLoopNode
  USE DataSizing
  USE DataGlobals_HPSimIntegrated,     ONLY: BeginEnvrnFlag, BeginDayFlag, MaxNameLength, SecInHour, &
  InitConvTemp, SysSizingCalc !, ShowWarningError, &
  !ShowFatalError, ShowSevereError, ShowContinueError
  USE DataInterfaces,  ONLY: SetupOutputVariable, ShowWarningMessage,  &
