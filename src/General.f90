  ...
  INTERFACE RoundSigDigits
    ...
    CONTAINS
      ...
      REAL(r64) FUNCTION InterpBlind(ProfAng,PropArray)
        ...
        ! USE STATEMENTS:
        USE DataGlobals_HPSimIntegrated, ONLY: Pi,PiOvr2
      ...
      FUNCTION CreateSysTimeIntervalString() RESULT(OutputString)
        ...
        ! USE STATEMENTS:
        USE DataGlobals_HPSimIntegrated,     ONLY: CurrentTime,TimeStepZone
      ...
      SUBROUTINE Invert3By3Matrix(A,InverseA)
        ...
        ! USE STATEMENTS:
        USE DataGlobals_HPSimIntegrated, ONLY: OutputFileStandard !, ShowFatalError
      ...
      SUBROUTINE ITERATE(ResultX,Tol,X0,Y0,X1,Y1,Iter,Cnvg)
        ...
        ! USE STATEMENTS:
        USE DataPrecisionGlobals
        !unused0909  use DataGlobals_HPSimIntegrated, only: outputfiledebug
      ...
      FUNCTION DetermineMinuteForReporting(IndexTypeKey) RESULT(ActualTimeMin)
        ...
        ! USE STATEMENTS:
        USE DataPrecisionGlobals
        USE DataGlobals_HPSimIntegrated, ONLY: ZoneTSReporting, HVACTSReporting, TimeStepZone, CurrentTime
        USE DataHVACGlobals, ONLY: TimeStepSys, SysTimeElapsed
      ...
      REAL(r64) FUNCTION GetCurrentHVACTime()
        ...
        ! USE STATEMENTS:
        USE DataGlobals_HPSimIntegrated,       ONLY : CurrentTime, TimeStepZone, SecInHour
