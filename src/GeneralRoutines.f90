SUBROUTINE ControlCompOutput(CompName,CompType,CompNum,FirstHVACIteration,QZnReq, &
  ...
  USE DataLoopNode
  USE DataGlobals_HPSimIntegrated,            ONLY : WarmUpFlag !,ShowWarningError,ShowFatalError,ShowContinueError,ShowSevereError
  USE DataInterfaces,         ONLY : ShowContinueErrorTimeStamp,ShowRecurringWarningErrorAtEnd,ShowWarningMessage
...
SUBROUTINE CheckSysSizing(CompType,CompName)
          ...
          ! USE STATEMENTS:
  USE DataPrecisionGlobals
  USE DataGlobals_HPSimIntegrated, ONLY: DoSystemSizing !, ShowSevereError,ShowContinueError,ShowFatalError
...
SUBROUTINE CheckZoneSizing(CompType,CompName)
          ...
          ! USE STATEMENTS:
  USE DataPrecisionGlobals
  USE DataGlobals_HPSimIntegrated, ONLY: DoZoneSizing !, ShowSevereError,ShowContinueError,ShowFatalError
...
SUBROUTINE TestAirPathIntegrity(ErrFound)
          ...
          ! USE STATEMENTS:
  USE DataPrecisionGlobals
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, OutputFileBNDetails !, ShowFatalError, ShowWarningError, &
                         !ShowSevereError, ShowMessage, ShowContinueError
  USE DataLoopNode
