Module EvaporativeCoolers
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: BeginEnvrnFlag,BeginDayFlag, SysSizingCalc, SecInHour !, &
  !ShowContinueError, ShowSevereError,ShowFatalError, ShowWarningError
