MODULE HVACSingleDuctInduc
  ...
  USE DataLoopNode
  USE DataGlobals_HPSimIntegrated,     ONLY: BeginEnvrnFlag, MaxNameLength, NumOfZones, InitConvTemp, &
  SysSizingCalc !, ShowWarningError, ShowFatalError, ShowSevereError, ShowContinueError
  USE DataInterfaces,  ONLY: SetupOutputVariable, ShowWarningMessage, ShowRecurringWarningErrorAtEnd
