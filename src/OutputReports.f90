...
SUBROUTINE DXFOut(PolygonAction,ColorScheme)
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: DegToRadians,NumOfZones !,ShowWarningError, ShowContinueError, ShowFatalError
...
SUBROUTINE DetailsForSurfaces(RptType)
  ...
  USE DataHeatBalance
  USE DataSurfaces
  USE DataGlobals_HPSimIntegrated, ONLY: NumOfZones,OutputFileInits
