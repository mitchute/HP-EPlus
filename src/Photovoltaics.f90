MODULE Photovoltaics
  ...
  ! USE STATEMENTS:
    ...
    USE DataGlobals_HPSimIntegrated, ONLY: BeginSimFlag, BeginEnvrnFlag, BeginDayFlag, EndEnvrnFlag, MaxNameLength, SecInHour, KelvinConv 
...
!unused0909  USE DataGlobals_HPSimIntegrated, ONLY: BeginEnvrnFlag, EndEnvrnFlag
...
SUBROUTINE GetPVInput
  ...
  USE InputProcessor,  ONLY: GetNumObjectsFound, GetObjectItem, VerifyName, FindItemInList, &
                            SameString
  USE DataIPShortCuts
  USE DataGlobals_HPSimIntegrated,     ONLY: DegToRadians, KelvinConv
...
SUBROUTINE CalcTRNSYSPV(PVNum,RunFlag)
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY:SecInHour,MinutesPerTimeStep
  USE DataSurfaces, ONLY: Surface
!  USE DataPhotovoltaics, ONLY:CellTemp,LastCellTemp
  USE DataHeatBalSurface, ONLY: TempSurfOut
  USE TranspiredCollector, ONLY: GetUTSCTsColl
