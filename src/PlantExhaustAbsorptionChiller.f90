...
SUBROUTINE GetExhaustAbsorberInput
  ...
  NumExhaustAbsorbers = GetNumObjectsFound(TRIM(cCurrentModuleObject))
  ...
  DO AbsorberNum = 1, NumExhaustAbsorbers
    ...
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Rate [W]', &
         ExhaustAbsorberReport(AbsorberNum)%HeatingLoad  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Energy [J]', &
    ...
    CALL SetupOutputVariable('Chiller Cond Heat Trans [J]', &
     ...
     CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Cooling ThermalEnergy COP [W/W]', &
    ...
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Cooling Electric Power [W]', &
         ExhaustAbsorberReport(AbsorberNum)%CoolElectricPower  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Cooling Electric Consumption [J]', &
    ...
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Electric Power [W]', &
         ExhaustAbsorberReport(AbsorberNum)%HeatElectricPower  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Electric Consumption [J]', &
    ...
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Hot Water Inlet Temp [C]', &
         ExhaustAbsorberReport(AbsorberNum)%HotWaterReturnTemp  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Hot Water Outlet Temp [C]', &
         ExhaustAbsorberReport(AbsorberNum)%HotWaterSupplyTemp  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Hot Water Mass Flow Rate [kg/s]', &
         ExhaustAbsorberReport(AbsorberNum)%HotWaterFlowRate  ,'System','Average',ChillerName)

    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Cooling Part Load Ratio', &
         ExhaustAbsorberReport(AbsorberNum)%CoolPartLoadRatio  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Cooling Capacity [W]', &
         ExhaustAbsorberReport(AbsorberNum)%CoolingCapacity  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Part Load Ratio', &
         ExhaustAbsorberReport(AbsorberNum)%HeatPartLoadRatio  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Capacity [W]', &
         ExhaustAbsorberReport(AbsorberNum)%HeatingCapacity  ,'System','Average',ChillerName)

    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Fraction of Period Running', &
         ExhaustAbsorberReport(AbsorberNum)%FractionOfPeriodRunning  ,'System','Average',ChillerName)

    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Exhaust Inlet Temp [C]', &
         ExhaustAbsorberReport(AbsorberNum)%ExhaustInTemp  ,'System','Average',ChillerName)
    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Exhaust Inlet Flow Rate [kg/s]', &
         ExhaustAbsorberReport(AbsorberNum)%ExhaustInFlow  ,'System','Average',ChillerName)

    CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heat Recovery Potential-During Heating [W]', &
         ExhaustAbsorberReport(AbsorberNum)%ExhHeatRecPotentialHeat  ,'System','Average',ChillerName)
   CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heat Recovery Potential-During Cooling [W]', &
         ExhaustAbsorberReport(AbsorberNum)%ExhHeatRecPotentialCool  ,'System','Average',ChillerName)

   CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Cooling Thermal Energy Consumption Rate [W]', &
         ExhaustAbsorberReport(AbsorberNum)%CoolThermalEnergyUseRate  ,'System','Average',ChillerName)
   CALL SetupOutputVariable('Exhaust Fired Absorption Chiller Heating Thermal Energy Consumption Rate [W]', &
...
!  LOGICAL             :: LoopErrorsFound
  ...
  IF (ExhaustAbsorber(ChillNum)%NomCoolingCap  == AutoSize) THEN
    ...
    ELSE
      ...
      CALL ShowContinueError('Occurs in Exhaust Fired Absorption Chiller object='//TRIM(ExhaustAbsorber(ChillNum)%Name))
      ErrorsFound = .TRUE.
    END IF
  END IF
    ...
    IF (PltSizCondNum > 0) THEN
      IF (PlantSizData(PltSizCoolNum)%DesVolFlowRate >= SmallWaterVolFlow) THEN
        ...
        tmpCondVolFlowRate = tmpNomCap * &
                             (1. + ExhaustAbsorber(ChillNum)%ThermalEnergyCoolRatio) / &
...
!    Node(lCondSupplyNodeNum)%MassFlowRate           = ExhaustAbsorberReport(ChillNum)%CondWaterFlowRate
  ...
  IF (ExhaustAbsorberReport(ChillNum)%CoolThermalEnergyUseRate .NE. 0.0) THEN
