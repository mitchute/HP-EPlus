MODULE IceThermalStorage  ! Ice Storage Module
  ...
  USE CurveManager
  USE DataLoopNode
  USE DataGlobals_HPSimIntegrated,     ONLY: WarmupFlag, BeginDayFlag, EndDayFlag, TimeStepZone, SecInHour, &
  HourOfDay,TimeStep !, ShowWarningError, ShowContinueError, ShowSevereError, ShowFatalError
...
CONTAINS
  ...
  SUBROUTINE SimIceStorage(IceStorageType,IceStorageName,CompIndex,RunFlag,FirstIteration, &
    ...
    USE DataGlobals_HPSimIntegrated,     ONLY: BeginEnvrnFlag, WarmupFlag
...
SUBROUTINE CalcIceStorageCapacity(IceStorageType,MaxCap,MinCap,OptCap)
  ...
  ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated,      ONLY: WarmupFlag, NumOfTimeStepInHour, HourOfDay, TimeStep
  USE ScheduleManager,  ONLY: GetCurrentScheduleValue
...
SUBROUTINE CalcIceStorageDischarge(IceStorageType,IceNum,MyLoad,Runflag,FirstIteration,MaxCap)
  ...
  ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: HourOfDay,TimeStep,NumOfTimeStepInHour !, ShowFatalError
  USE DataHVACGlobals, ONLY : TimeStepSys
  USE DataPlant, ONLY:  PlantLoop, SingleSetpoint, DualSetpointDeadband
