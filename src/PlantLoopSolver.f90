MODULE PlantLoopSolver
  ...
  USE DataGlobals_HPSimIntegrated,          ONLY: MaxNameLength, RefrigIndex
                                        ...
                                        TypeOf_Generator_FCStackCooler,      &
                                          TypeOf_Generator_MicroCHP,           &
                                            ...
                                            SUBROUTINE  CheckLoopExitNode(LoopNum,FirstHVACIteration)
                                              ...
                                              ! USE STATEMENTS:
                                              USE DataGlobals_HPSimIntegrated,     ONLY: WarmUpFlag, BeginEnvrnFlag !, ShowWarningError,ShowContinueError
