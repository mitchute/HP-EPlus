MODULE PlantPipingSystemsManager
    ...
    USE DataGlobals_HPSimIntegrated,          ONLY: MaxNameLength,outputfiledebug !ShowWarningError, ShowSevereError, ShowFatalError, &
                                    !ShowContinueError,
...
SUBROUTINE ReadGeneralDomainInputs(IndexStart, NumGeneralizedDomains, ErrorsFound)
    ...
    USE General, ONLY: TrimSigDigits
    USE DataGlobals_HPSimIntegrated, ONLY: SecsInDay
...
SUBROUTINE InitPipingSystems(DomainNum, CircuitNum)
    ...
    USE DataGlobals_HPSimIntegrated,       ONLY : BeginSimFlag, BeginEnvrnFlag, DayOfSim, HourOfDay, &
...
REAL(r64) FUNCTION EvaluateGroundSurfaceTemperature(DomainNum, cell) RESULT(RetVal)
    ...
    USE DataGlobals_HPSimIntegrated, ONLY: SecsInDay, SecInHour
