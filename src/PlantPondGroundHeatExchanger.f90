MODULE PondGroundHeatExchanger
  ...
  USE DataInterfaces
  USE DataGlobals_HPSimIntegrated,       ONLY : MaxNameLength, KelvinConv
...
CONTAINS
  ...
  SUBROUTINE InitPondGroundHeatExchanger(PondGHENum,FirstHVACIteration,RunFlag)
    ...
    USE DataGlobals_HPSimIntegrated,     ONLY: BeginTimeStepFlag, PI,warmupflag
    ...
    SUBROUTINE CalcPondGroundHeatExchanger(PondGHENum)
      ...
      USE DataGlobals_HPSimIntegrated,       ONLY : SimTimeSteps, CurrentTime, BeginDayFlag, SecInHour
    ...
    FUNCTION CalcEffectiveness(InsideTemperature, PondTemperature,MassFlowRate,PondGHENum)
      ...
      ! USE STATEMENTS:
      USE DataGlobals_HPSimIntegrated,     ONLY : PI, NumOfTimeStepInHour
      USE General,         ONLY : RoundSigDigits
