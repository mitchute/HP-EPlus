...
USE DataGlobals_HPSimIntegrated,       ONLY : MaxNameLength, BeginTimeStepFlag, KelvinConv !, ShowWarningError, ShowSevereError, &
...
SUBROUTINE InitSurfaceGroundHeatExchanger(SurfaceGHENum,RunFlag)
  ...
  USE DataGlobals_HPSimIntegrated,     ONLY : BeginTimeStepFlag, PI, BeginEnvrnFlag
  USE DataEnvironment
