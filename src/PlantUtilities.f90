...
SUBROUTINE SetComponentFlowRate(CompFlow,InletNode,OutletNode,LoopNum,LoopSideNum,BranchIndex,CompIndex)
  ...
  USE DataGlobals_HPSimIntegrated,          ONLY : SysSizingCalc !, ShowFatalError, ShowContinueError, ShowSevereError
...
SUBROUTINE CheckPlantMixerSplitterConsistency(LoopNum,LoopSideNum,SplitNum, MixNum,FirstHVACIteration)
  ...
  USE DataBranchAirLoopPlant, ONLY : MassFlowTolerance
  USE DataInterfaces,       ONLY : ShowContinueErrorTimeStamp
  USE DataGlobals_HPSimIntegrated,          ONLY : WarmupFlag, DoingSizing !, ShowFatalError, ShowSevereError, ShowContinueError
  USE General,              ONLY : RoundSigDigits
  IMPLICIT NONE ! Enforce explicit typing of all variables in this routine
