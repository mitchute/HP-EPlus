MODULE PlantValves
  ...
  USE DataLoopNode
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength !, ShowWarningError, ShowSevereError, ShowFatalError
...
CONTAINS
  ...
  SUBROUTINE SimPlantValves(CompTypeNum,CompName,CompNum,RunFlag,InitLoopEquip,  &
    ...
    ! USE STATEMENTS:
    USE DataGlobals_HPSimIntegrated, ONLY: BeginEnvrnFlag !, ShowFatalError, ShowContinueError, ShowSevereError
  ...
  SUBROUTINE GetPlantValvesInput
    ...
    ! USE STATEMENTS:
    !USE DataGlobals_HPSimIntegrated, ONLY :  ShowSevereError, ShowWarningError, ShowFatalError
  ...
  SUBROUTINE InitPlantValves(CompTypeNum,CompNum, FirstHVACIteration)
    ...
    ! USE STATEMENTS:
    USE DataGlobals_HPSimIntegrated,       ONLY: BeginEnvrnFlag !, ShowSevereError, ShowWarningError, ShowContinueError
