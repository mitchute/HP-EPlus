...
USE DataGlobals_HPSimIntegrated,     ONLY: MaxNameLength, NumOfTimeStepInHour, InitConvTemp, SecInHour, OutputFileInits
...
SUBROUTINE SimWaterThermalTank(CompType,CompName,CompIndex,RunFlag,InitLoopEquip,  &  !DSU
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: BeginEnvrnFlag, KickOffSimulation
...
SUBROUTINE SimHeatPumpWaterHeater(CompName,FirstHVACIteration,SensLoadMet,LatLoadMet,CompIndex)
  ...
  USE General,        ONLY: TrimSigDigits
  USE DataGlobals_HPSimIntegrated,    ONLY: DoingSizing !, ShowFatalError
...
SUBROUTINE CalcWaterThermalTankZoneGains
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: BeginEnvrnFlag, DoingSizing
...
SUBROUTINE GetWaterThermalTankInput
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated,        ONLY: MaxNameLength, NumOfZones, AutoCalculate, outputfiledebug !, &
                                !ShowSevereError, ShowWarningError, ShowFatalError, ShowContinueError
...
SUBROUTINE InitWaterThermalTank(WaterThermalTankNum, FirstHVACIteration, LoopNum, LoopSideNum )
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated,       ONLY: BeginEnvrnFlag, WarmupFlag, AnyPlantInModel !, ShowSevereError, ShowWarningError, ShowContinueError
...
SUBROUTINE CalcWaterThermalTankMixed(WaterThermalTankNum)
  ...
  USE DataGlobals_HPSimIntegrated,     ONLY: TimeStep, TimeStepZone, WarmupFlag, HourOfDay !, ShowWarningError, ShowContinueError
...
SUBROUTINE CalcWaterThermalTankStratified(WaterThermalTankNum)
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated,     ONLY: TimeStep, TimeStepZone, HourOfDay
  USE DataHVACGlobals, ONLY: SysTimeElapsed, TimeStepSys
  USE FluidProperties, ONLY: GetDensityGlycol, GetSpecificHeatGlycol
...
SUBROUTINE CalcDesuperheaterWaterHeater(WaterThermalTankNum,FirstHVACIteration)
  ...
  USE DataGlobals_HPSimIntegrated,       ONLY: SecInHour, WarmupFlag, DoingSizing, KickOffSimulation !, &
...
SUBROUTINE CalcHeatPumpWaterHeater(WaterThermalTankNum,FirstHVACIteration)
  ...
  USE DataGlobals_HPSimIntegrated,       ONLY: WarmupFlag, DoingSizing, KickOffSimulation !, ShowFatalError, ShowSevereError, ShowWarningError, ShowContinueError
  USE DataInterfaces,    ONLY: ShowContinueErrorTimeStamp, ShowRecurringWarningErrorAtEnd
...
!  USE DataGlobals_HPSimIntegrated, ONLY: ShowFatalError, ShowSevereError, ShowContinueError, ShowWarningError
...
SUBROUTINE SizeTankForDemandSide(WaterThermalTankNum)
  ...
  USE DataSizing
  USE DataPlant, ONLY : PlantLoop
  USE DataGlobals_HPSimIntegrated, ONLY: PI !, ShowFatalError, ShowSevereError, ShowContinueError, ShowWarningError
  USE DataHVACGlobals, ONLY: SmallWaterVolFlow, NumPlantLoops
  USE FluidProperties, ONLY: GetDensityGLycol, GetSpecificHeatGlycol
  USE OutputReportPredefined
...
SUBROUTINE SizeTankForSupplySide(WaterThermalTankNum)
  ...
  USE SolarCollectors, ONLY: Collector, NumOfCollectors
  USE DataSurfaces, ONLY: Surface
  USE DataGlobals_HPSimIntegrated, ONLY: Pi !, ShowFatalError
  IMPLICIT NONE    ! Enforce explicit typing of all variables in this routine
...
SUBROUTINE CalcStandardRatings(WaterThermalTankNum)
  ...
  USE DataGlobals_HPSimIntegrated,     ONLY: InitConvTemp !, ShowWarningError, ShowContinueError
  USE CurveManager,    ONLY: CurveValue
