MODULE WaterUse
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: WarmupFlag, MaxNameLength, BeginEnvrnFlag, InitConvTemp, NumOfZones
  USE DataInterfaces
...
CONTAINS
  ...
  SUBROUTINE InitConnections(WaterConnNum, FirstHVACIteration)
    ...
    ! USE STATEMENTS:
    USE DataGlobals_HPSimIntegrated, ONLY: SysSizingCalc, DoingSizing
    USE ScheduleManager, ONLY: GetCurrentScheduleValue
