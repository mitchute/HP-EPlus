...
MODULE HeatPumpWaterToWaterHEATING
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, BeginSimFlag,InitconvTemp,BeginEnvrnFlag, HourOfDay, KelvinConv,  &
...
MODULE HeatPumpWaterToWaterCOOLING
  ...
  ! Use statements for data only modules
  USE DataPrecisionGlobals
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, BeginSimFlag,InitconvTemp,BeginEnvrnFlag, HourOfDay,   &
  TimeStep,TimeStepZone,DayOfSim,WarmupFlag,SecInHour
  USE DataInterfaces
  USE DataLoopNode
