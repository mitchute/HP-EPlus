Module PollutionModule
    ...
    USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength,HourOfDay,TimeStep,TimeStepZone,  &
...
!    USE DataGlobals_HPSimIntegrated, ONLY: ShowWarningError,ShowSevereError,ShowFatalError
