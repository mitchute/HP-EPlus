MODULE PoweredInductionUnits
  ...
  USE DataLoopNode
  USE DataGlobals_HPSimIntegrated,     ONLY: BeginEnvrnFlag, BeginDayFlag, MaxNameLength, SecInHour, NumOfZones, &
  InitConvTemp, SysSizingCalc !, ShowWarningError, ShowFatalError, ShowSevereError, ShowContinueError
