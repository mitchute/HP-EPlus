...
SUBROUTINE GetUserDefinedPatternData(ErrorsFound)
          ...
          ! USE STATEMENTS:
          ! na
  USE DataGlobals_HPSimIntegrated,    ONLY: NumOfZones !, ShowMessage
...
SUBROUTINE GetAirNodeData(ErrorsFound)
    ...
    INTEGER :: NumOfZones   !This isn't currently called out
...
SUBROUTINE SharedDVCVUFDataInit(ZoneNum)
  ...
  USE DataSurfaces
  USE DataGlobals_HPSimIntegrated,  ONLY : NumOfZones, MaxNameLength !, ShowWarningError, ShowFatalerror, ShowSevereError, ShowContinueError
  USE DataHeatBalance, ONLY : Zone
  USE DataAirflowNetwork
  ...
  INTEGER         :: NodeNum2 = 0 ! The Second node number in an AirflowNetwork linkage data
   ...
   INTEGER :: BeginEnvrnFlag   !This isn't currently called out
