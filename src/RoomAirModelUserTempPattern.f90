MODULE RoomAirModelUserTempPattern
    ...
    USE DataGlobals_HPSimIntegrated,       ONLY : MaxNameLength, DisplayExtraWarnings !, ShowWarningError, ShowFatalError
...
!***************************************************
  SUBROUTINE SetSurfHBDataForTempDistModel(ZoneNum)
    ...
    USE DataGlobals_HPSimIntegrated,                ONLY : ZoneSizingCalc
