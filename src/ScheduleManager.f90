MODULE ScheduleManager
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: MaxNameLength, HourOfDay, OutputFileInits, NumOfTimeStepInHour, MinutesPerTimeStep, TimeStep,  &
    OutputFileDebug 
...
SUBROUTINE ReportOrphanSchedules
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: DisplayUnusedSchedules
