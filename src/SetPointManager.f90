...
USE DataLoopNode
USE DataAirLoop
USE DataGlobals_HPSimIntegrated,     ONLY: BeginEnvrnFlag, BeginDayFlag, NumOfZones, MaxNameLength, &
                           MetersHaveBeenInitialized, RunOptCondEntTemp !, ShowFatalError, &
                           !ShowSevereError, ShowContinueError, ShowWarningError
USE DataInterfaces,  ONLY: SetupOutputVariable, GetInternalVariableValue
...
SUBROUTINE CalcMixedAirSetPoint(SetPtMgrNum)
          ...
          ! USE STATEMENTS:
  USE DataGlobals_HPSimIntegrated, ONLY: SysSizingCalc, AnyEnergyManagementSystemInModel
...
SUBROUTINE CheckIFAnyIdealCondEntSetPoint
  ...
  USE DataGlobals_HPSimIntegrated ,    ONLY: AnyIdealCondEntSetPointInModel
