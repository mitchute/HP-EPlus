...
MODULE vectors
  ...
  USE DataGlobals_HPSimIntegrated, ONLY: DegToRadians, PI, PIOvr2, outputfiledebug
  USE DataVectorTypes
                          ...
                          INTERFACE OPERATOR (.dot.)
                            ...
                            INTERFACE OPERATOR (.twoddot.)
                              ...
                              Module DXFEarClipping
                                ...
                                use DataPrecisionGlobals
                                use DataVectorTypes
                                use DataGlobals_HPSimIntegrated, ONLY: Pi,DegToRadians,outputfiledebug
                              ...
                              contains
                                ...
                                Integer Function Triangulate(nsides,polygon,outtriangles,surfazimuth,surftilt,surfname,surfclass)
                                  ...
                                  USE DataGlobals_HPSimIntegrated, ONLY: DisplayExtraWarnings !,ShowWarningError,ShowMessage,ShowContinueError
