MODULE WindowAC
  ...
  USE DataLoopNode
  USE DataSizing
  USE DataGlobals_HPSimIntegrated,     ONLY: BeginEnvrnFlag, BeginDayFlag, MaxNameLength, SecInHour, OutputFileDebug, SysSizingCalc !, &
  !ShowWarningError, ShowFatalError, ShowSevereError, ShowContinueError
  USE DataInterfaces,  ONLY: ShowContinueErrorTimeSTamp, SetupOutputVariable, ShowRecurringWarningErrorAtEnd, ShowWarningMessage
...
CONTAINS
  ...
  SUBROUTINE GetWindowAC
    ...
    USE DataGlobals_HPSimIntegrated,           ONLY: AnyEnergyManagementSystemInModel, NumOfZones
